  ...
  const projectList: Project[] = [
    {
      ...
      img: nft,
      desc: "A landing page about ETH with responsive",
    ...
    },
    {
      ...
      img: movies,
      desc: "Use Tmdb API to build a movie website with more functions",
      ...
      <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-8 gap-y-12">
        {projectList.map((project) => (
          <div
            key={project.date}
            data-aos="zoom-in-up"
            className="w-full flex flex-col rounded-xl overflow-hidden shadow-xl cursor-pointer hover:shadow-2xl hover:translate-y-3 transition-transform"
          >
