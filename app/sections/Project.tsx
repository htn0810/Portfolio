  ...
  return (
    <section id='project' className='w-full 2xl:mt-10 md:mt-6 mt-4 items-center px-3'>
      <div className='flex flex-col items-center mb-4'>
        <h2 className='text-[#42446E] md:text-[30px] text-[24px] font-bold text-center mb-4'>Project</h2>
        <span className='text-[#666] md:text-lg text-base leading-8 font-normal text-center'>Things I’ve built so far</span>
      </div>
          ...
          <Fragment key={project.date}>
            <div data-aos="zoom-in-up" className="w-full flex flex-col rounded-xl overflow-hidden shadow-xl cursor-pointer hover:-translate-y-2 transition-transform">
              ...
              <div className='px-4 py-6 flex-1'>
                  <h2 className='xl:text-2xl text-lg font-medium'>{ project.title }</h2>
                  <p className='xl:text-lg text-base font-light leading-6 text-[#666] my-2'>{ project.desc }</p>
                <div className='text-[#42446E] items-center'>
                  <span className='md:text-base text-sm font-normal'>Tech stack: 
                  <span className='md:text-sm text-xs font-light'>{ project.tech }</span> </span>
                  </div>
              </div>
              <div className='flex justify-between items-center font-bold text-sm text-[#666] px-4 py-6'>
                <span className='flex gap-x-2 items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="2xl:w-6 2xl:h-6 w-4 h-4">
